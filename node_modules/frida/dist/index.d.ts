...
export declare type AttachParameters = deviceModule.AttachParameters;
...
export declare function attach(targetOrParameters: TargetProcess | AttachParameters, cancellable?: Cancellable): Promise<Session>;
